      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="<?= base_url('status_pemesanan') ?>">Status Pemesanan</a></li>
            <li><a href="<?= base_url('konfirmasi_pemesanan') ?>">Konfirmasi Pemesanan</a></li>
            <li><a href="<?= base_url('daftar-transaksi') ?>">Daftar Transaksi</a></li>
          </ul>
              ...
              <div class="transaction">
                <div class="transaction-content">
                  ...
                  <div class="transaction-detail">
                    <p>Verifikasi konfirmasi pembayaran</p>
                    <p>Pembayaran telah diterima dan pesanan anda sedang diproses</p>
                  </div>
