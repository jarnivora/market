              ...
              <div class="transaction">
                <div class="transaction-content">
                  ...
                  <div class="transaction-action">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#confModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Anda yakin ingin menandai transaksi selesai? Jika anda mengalami masalah, gunakan fitur komplain untuk menyelesaikannya.</p>
      </div>
      <div class="modal-footer">
        <button class="btn btn-primary" type="button" data-dismiss="modal">
          Terima
        </button>
        <a href="<?= base_url('komplain') ?>" class="btn btn-danger">
          Komplain
        </a>
