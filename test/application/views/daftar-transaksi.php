      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <ul class="nav nav-tabs">
            ...
            <li><a href="<?= base_url('konfirmasi_pemesanan') ?>">Konfirmasi Pemesanan</a></li>
            <li class="active"><a href="./<?= base_url('daftar_transaksi') ?>">Daftar Transaksi</a></li>
          </ul>
              ...
              <form action=" " id="filterForm">
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <select name="" id="statusTrans" class="form-control">
                  ...
                  <div class="col-sm-3">
                    <label for="startdate">Awal filter</label>
                    <input id="startdate" type="date" class="form-control">
                  </div>
                  <div class="col-sm-3">
                    <label for="enddate">Akhir filter</label>
                    <input id="enddate" type="date" class="form-control">
                  </div>
                  <div class="col-sm-3">
                    <label for="searchBox">Cari transaksi</label>
                    <div class="input-group">
                      <input id="searchBox" type="text" class="form-control" placeholder="Invoice / Produk">
              ...
              <div class="transaction">
                <div class="transaction-content">
                  ...
                  <div class="transaction-detail">
                    <p>03 Mei 2017, Transaksi Selesai</p>
                    <p>Nomor Resi: 021430180211513</p>
                  </div>
                  <div class="transaction-action">
                    <button class="btn btn-primary"><i class="glyphicon glyphicon-shopping-cart"></i> Beli Lagi</button>
                  </div>
                  <a href="#" class="transaction-timeline-action">Tampilkan <i class="fa fa-chevron-down"></i></a>
                </div>
                <div class="transaction-timeline">
                  <div class="transaction-timeline-item">
                    <div class="row">
                      <b class="col-sm-2">03/05/2017 12:03</b>
                      <p class="col-sm-10">
                        Transaksi selesai
                      </p>
                    </div>
                  ...
                  <div class="transaction-timeline-item">
                    <div class="row">
                      <b class="col-sm-2">02/05/2017 18:58</b>
                      <p class="col-sm-10">
                  ...
                  <div class="transaction-timeline-item">
                    <div class="row">
                      <b class="col-sm-2">02/05/2017 12:53</b>
                      <p class="col-sm-10">
                        Verifikasi konfirmasi pembayaran<br>
                  ...
                  <div class="transaction-timeline-item">
                    <div class="row">
                      <b class="col-sm-2">02/05/2017 09:03</b>
                      <p class="col-sm-10">
                        Check out berhasil<br>
                ...
                <div class="transaction-timeline">
                  ...
                  <div class="transaction-timeline-item">
                    <div class="row">
                      <b class="col-sm-2">02/05/2017 18:58</b>
                      <p class="col-sm-10">
                        Pesanan telah dikirim<br>
                        Pesanan anda dalam proses pengiriman oleh kurir<br>
                        Nomor Resi: 021430180211513
                      </p>
                    </div>
                  </div>
                  <div class="transaction-timeline-item">
