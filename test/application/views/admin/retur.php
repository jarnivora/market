...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Retur</h4>
                            </div>
                        </div> <!-- end row -->
                        <table id="mainTable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <td>
                                    Tracking number: 77749392 <br>
                                    Shipped back by user
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#accModal">
        ...
        <div id="accModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button data-dismiss="modal" class="close">&times;</button>
                        <b class="modal-title">Mark Shipment</b>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to mark return as accepted?</p>
                    </div>
