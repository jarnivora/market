            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        ...
                        <?= form_open_multipart('admin/add_supplier/save');?>
                            <div class="row">
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="phone" id="phone" class="form-control" min="0">
                                    </div>
                                </div>
                                 <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="address" class="form-control" id="addr" rows="7"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <br>
