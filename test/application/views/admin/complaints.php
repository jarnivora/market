                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Complaints</h4>
                            </div>
                        </div> <!-- end row -->
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <i class="fa fa-comments"></i> Resolve
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <b class="modal-title">Complaint details</b>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <p>
                                    It doesn't work out of the box. Simple as that.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <a href="#" class="btn btn-success">Resolve problems</a>
                    </div>
                </div>
            </div>
        </div>
