...
<html lang="en">
    <head>
        ...
        <!-- jvectormap -->
        <link href="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    ...
    <body>
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title">Google Maps</h4>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
                        ...
                        <div class="row p-t-50">
                            <div class="col-sm-12">
                                <h4 class="header-title">Vector Maps</h4>
                            </div> <!-- end col -->
                        </div> <!-- end row -->
        ...
        <!-- Gmaps file -->
        <script src="<?= base_url() ?>design/admin/assets/plugins/gmaps/gmaps.min.js"></script>

        <!-- Google map Init -->
        <script src="<?= base_url() ?>design/admin/assets/pages/jquery.gmaps.js"></script>

        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/gdp-data.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-us-aea-en.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-uk-mill-en.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-au-mill.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-ca-lcc.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-de-mill.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-in-mill.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/plugins/jvectormap/jquery-jvectormap-asia-mill.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/pages/jquery.jvectormap.init.js"></script>
