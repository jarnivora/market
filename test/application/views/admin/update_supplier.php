                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="<?= base_url('admin/manage_supplier') ?>">Supplier</a></li>
                                    <li></li>
                                </ul>
                                <h4 class="header-title m-t-0 m-b-20">Add Supplier</h4>
                            </div>
                        </div> <!-- end row -->
                        <?= $this->session->flashdata('notification') ?>
                        <?= form_open_multipart('admin/manage_supplier/edit');?>
                        <?php $i=1; foreach($data['getUserWhere'] as $resUser): ?>
                            <div class="row">
                            <input type="hidden" name="id" value="<?= $resUser->id_supplier ?>" >
                                <div class="col-md-6">
                                    <label for="name">Supplier Name</label>
                                    <input type="text" name="username" class="form-control" value="<?= $resUser->nama_supplier ?>" id="name">
                                </div>
                                 <div class="col-md-6">
                                    <label for="ship">No Handphone</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">+62</span>
                                        <input type="number" name="phone" id="price" value="<?= $resUser->no_hp ?>" class="form-control" min="0">
                                    </div>
                                </div>
                                 <div class="col-md-12">
                                    <label for="name">Person in charge</label>
                                    <input type="text" name="pic" value="<?= $resUser->nama_penanggungjawab ?>" class="form-control" id="name">
                                </div>
                                <div class="col-md-12">
                                    <label for="addr">Address</label>
                                    <textarea name="address" class="form-control" id="addr" rows="7"><?= $resUser->alamat ?></textarea>
                                </div>
                                <div class="col-md-12">
                                    <br>
                                    <a href="<?= base_url('admin/manage_supplier') ?>" class="btn btn-danger">Cancel</a>
