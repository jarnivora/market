                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 card-box">
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" action="#">
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                <a href="<?= base_url('admin/pages_forget_password') ?>" class="text-muted pull-right font-14">Forgot your password?</a>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Don't have an account? <a href="<?= base_url('admin/pages_register') ?>" class="text-dark m-l-5">Sign Up</a></p>
                                </div>
                            </div>
