                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Manage Category</h4>
                            </div>
                        </div> <!-- end row -->
                        <div id="filter-box">
                            <a href="<?= base_url('admin/add_brand') ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add</a>
                        </div>
                              ...
                              <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?= base_url() ?>admin/manage_brand/update_merk/<?= $resUser->id_merk ?>">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a href=" <?= base_url() ?>admin/manage_brand/delete/<?= $resUser->id_merk ?>">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href=" <?= base_url() ?>admin/manage_category/delete/<?= $resUser->id_kategori ?>">
