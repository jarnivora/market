                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Manage Orders</h4>
                            </div>
                        </div> <!-- end row -->
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#confShip">
                                                    <i class="fa fa-check"></i> Mark as Shipped
                                                </a>
                                            </li>
                                            <li>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#confPay">
                                                    <i class="fa fa-check"></i> Confirm Payment Manually
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" data-toggle="modal" data-target="#confCanc">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confShip">Mark as shipped</button>
                    </div>
                </div>
            </div>
        </div>
