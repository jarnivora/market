...
<html lang="en">
    <head>
        ...
        <!-- ION Slider -->
        <link href="<?= base_url() ?>design/admin/assets/plugins/ion-rangeslider/ion.rangeSlider.css" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() ?>design/admin/assets/plugins/ion-rangeslider/ion.rangeSlider.skinModern.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <!-- Ion Range slider js -->
        <script src="<?= base_url() ?>design/admin/assets/plugins/ion-rangeslider/ion.rangeSlider.min.js"></script>
        <script src="<?= base_url() ?>design/admin/assets/pages/jquery.range-sliders.js"></script>
