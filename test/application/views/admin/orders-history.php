                            ...
                            <ul class="metisMenu nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav-second-level nav">
                                        ...
                                        <li><a href="<?= base_url('admin/order') ?>"><i class="ti-shopping-cart-full"></i> Manage Orders</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Orders History</h4>
                            </div>
                        </div> <!-- end row -->
