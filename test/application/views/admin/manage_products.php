                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Manage Products</h4>
                            </div>
                        </div> <!-- end row -->
                        <div id="filter-box">
                            <a href="<?= base_url('admin/add_product') ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add</a>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?= base_url() ?>admin/manage_products/update_products/<?= $resUser->id_produk ?>">
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?= base_url() ?>admin/manage_products/delete/<?= $resUser->id_produk ?>">
