            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="<?= base_url('admin/manage_brand') ?>">Manage Brand</a></li>
                                    <li></li>
                                </ul>
                        ...
                        <?= form_open_multipart('admin/manage_brand/edit');?>
                        <?php $i=1; foreach($data['getUserWhere'] as $resUser): ?>
                            <div class="row">
                            <input type="hidden" name="id" value="<?= $resUser->id_merk ?>" >
                                <div class="col-md-12">
                                    <label for="merk">Brand Name</label>
                                    <input type="text" name="merk" class="form-control" id="merk" value="<?= $resUser->nama_merk ?>">
                                </div>
                                <div class="col-md-12">
                                    <br>
                                    <a href="<?= base_url('admin/manage_brand') ?>" class="btn btn-danger">Cancel</a>
