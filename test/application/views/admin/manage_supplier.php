                        ...
                        <div>
                            ...
                            <ul class="metisMenu nav" id="side-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="nav-second-level nav">
                                        <li><a href="<?= base_url('admin/add_product') ?>"><i class="fa fa-plus"></i> Add Category</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="nav-second-level nav">
                                        ...
                                        <li><a href="<?= base_url('admin/complaints') ?>"><i class="ti-receipt"></i> Retur</a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="header-title m-t-0 m-b-20">Manage Supplier</h4>
                            </div>
                        </div> <!-- end row -->
                        <div id="filter-box">
                            <a href="<?= base_url('admin/add_supplier') ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add</a>
                        </div>
                        ...
                        <table id="mainTable" class="table table-striped">
                            ...
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $resUser->nama_supplier ?></td>
                                <td><?= $resUser->nama_penanggungjawab ?></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?= base_url() ?>admin/manage_supplier/update_supplier/<?= $resUser->id_supplier ?>">
                            ...
                            <div id="delModal" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <a href=" <?= base_url() ?>admin/manage_supplier/delete/<?= $resUser->id_supplier ?>">
                                            <button class="btn btn-danger">Confirm</button></a>
