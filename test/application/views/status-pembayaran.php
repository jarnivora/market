      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <ul class="nav nav-tabs">
            <li class="active"><a href="<?= base_url('status_pembayran') ?>">Status Pembayaran</a></li>
          ...
          <div class="tab-content">
            <table class="table table-bordered table-responsive table-striped">
              ...
              <tr>
                <td>02/05/2017 04:13</td>
                <td>INV/20170502/XVII/V/80813918</td>
                <td>Rp. 90.000</td>
                <td>4022561231</td>
                <td>POSSI BNI (423 336 7000)</td>
                <td>
                  <a href="#">aksi</a>
                </td>
              </tr>
