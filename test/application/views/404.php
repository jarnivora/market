              ...
              <ul class="dropdown-menu">
                <li>
                  <table class="table">
                    <tbody>
                      <tr>
                        <td class="text-center"><a href="product.html"><img class="img-thumbnail" title="Xitefun Causal Wear Fancy Shoes" alt="Xitefun Causal Wear Fancy Shoes" src="<?= base_url() ?>design/image/product/sony_vaio_1-50x50.jpg"></a></td>
                      ...
                      <tr>
                        <td class="text-center"><a href="product.html"><img class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="<?= base_url() ?>design/image/product/samsung_tab_1-50x50.jpg"></a></td>
      ...
      <div class="container">
        <div class="row"> <span class="drop-icon visible-sm visible-xs"><i class="fa fa-align-justify"></i></span>
          <div class="pull-left flip left-top">
            <div class="links">
              <ul>
                <li class="email"><a href="mailto:info@possimarketplace.com"><i class="fa fa-envelope"></i>info@possimarketplace.com</a></li>
              </ul>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div id="content" class="col-sm-12">
          ...
          <div class="buttons text-center"> <a class="btn btn-primary btn-lg" href="<?= base_url('home') ?>">Continue</a> </div>
        </div>
        <!--Middle Part End -->
      </div>
    </div>
